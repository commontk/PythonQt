...
{ Q_OBJECT
public:
Q_ENUMS(Stacks ResourceType MetaInformation FindFlag )
Q_FLAGS(FindFlags )
enum Stacks{
...
class PythonQtShell_QTextEdit_ExtraSelection : public QTextEdit::ExtraSelection
{
public:
    PythonQtShell_QTextEdit_ExtraSelection():QTextEdit::ExtraSelection(),_wrapper(NULL) {};

   ~PythonQtShell_QTextEdit_ExtraSelection();


  PythonQtInstanceWrapper* _wrapper; 
};

class PythonQtWrapper_QTextEdit_ExtraSelection : public QObject
{ Q_OBJECT
public:
public slots:
QTextEdit::ExtraSelection* new_QTextEdit_ExtraSelection();
QTextEdit::ExtraSelection* new_QTextEdit_ExtraSelection(const QTextEdit::ExtraSelection& other) {
PythonQtShell_QTextEdit_ExtraSelection* a = new PythonQtShell_QTextEdit_ExtraSelection();
*((QTextEdit::ExtraSelection*)a) = other;
return a; }
void delete_QTextEdit_ExtraSelection(QTextEdit::ExtraSelection* obj) { delete obj; } 
