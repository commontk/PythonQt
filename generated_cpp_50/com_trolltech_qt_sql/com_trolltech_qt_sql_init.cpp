...
PythonQt::priv()->registerCPPClass("QSqlField", "", "QtSql", PythonQtCreateObject<PythonQtWrapper_QSqlField>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
