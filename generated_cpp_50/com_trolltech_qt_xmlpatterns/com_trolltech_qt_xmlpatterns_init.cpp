...
PythonQt::priv()->registerCPPClass("QSourceLocation", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QSourceLocation>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QXmlName", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QXmlName>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QXmlNodeModelIndex", "", "QtXmlPatterns", PythonQtCreateObject<PythonQtWrapper_QXmlNodeModelIndex>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
