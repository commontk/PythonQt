...
{ Q_OBJECT
public:
Q_ENUMS(StyleHint Capitalization StyleStrategy SpacingType Style Weight Stretch )
enum StyleHint{
...
void delete_QImage(QImage* obj) { delete obj; } 
    ...
    const uchar*  constBits(QImage* theWrappedObject) const;
    const uchar*  constScanLine(QImage* theWrappedObject, int  arg__1) const;
...
{ Q_OBJECT
public:
Q_ENUMS(StandardKey SequenceFormat SequenceMatch )
enum StandardKey{
...
{ Q_OBJECT
public:
Q_ENUMS(FormatType ObjectTypes Property PageBreakFlag )
