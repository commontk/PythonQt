...
PythonQt::priv()->registerCPPClass("QImage", "", "QtGui", PythonQtCreateObject<PythonQtWrapper_QImage>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QImage>, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QLine", "", "QtGui", PythonQtCreateObject<PythonQtWrapper_QLine>, NULL, module, PythonQt::Type_Multiply|PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QLineF", "", "QtGui", PythonQtCreateObject<PythonQtWrapper_QLineF>, NULL, module, PythonQt::Type_Multiply|PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QMatrix", "", "QtGui", PythonQtCreateObject<PythonQtWrapper_QMatrix>, NULL, module, PythonQt::Type_Multiply|PythonQt::Type_InplaceMultiply|PythonQt::Type_RichCompare);
