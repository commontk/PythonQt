...
{ Q_OBJECT
public:
Q_ENUMS(ProcessState ProcessError ProcessChannelMode ExitStatus ProcessChannel )
enum ProcessState{
...
{ Q_OBJECT
public:
Q_ENUMS(SystemSemaphoreError AccessMode )
...
{ Q_OBJECT
public:
Q_ENUMS(FieldAlignment NumberFlag Status RealNumberNotation )
Q_FLAGS(NumberFlags )
enum FieldAlignment{
...
{ Q_OBJECT
public:
Q_ENUMS(State CurveShape Direction )
enum State{
