...
PythonQt::priv()->registerCPPClass("QAuthenticator", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QAuthenticator>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QHostAddress", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QHostAddress>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QSslCertificate", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QSslCertificate>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QSslCipher", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QSslCipher>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QSslConfiguration", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QSslConfiguration>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QSslKey", "", "QtNetwork", PythonQtCreateObject<PythonQtWrapper_QSslKey>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
