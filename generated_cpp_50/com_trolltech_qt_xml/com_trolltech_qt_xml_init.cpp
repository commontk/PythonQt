...
PythonQt::priv()->registerCPPClass("QDomAttr", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomAttr>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomCDATASection", "QDomText", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomCDATASection>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomCharacterData", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomCharacterData>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomComment", "QDomCharacterData", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomComment>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomDocument", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomDocument>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomDocumentFragment", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomDocumentFragment>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomDocumentType", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomDocumentType>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomElement", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomElement>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomEntity", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomEntity>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomEntityReference", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomEntityReference>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomImplementation", "", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomImplementation>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QDomNode", "", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomNode>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
...
PythonQt::priv()->registerCPPClass("QDomNotation", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomNotation>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomProcessingInstruction", "QDomNode", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomProcessingInstruction>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
PythonQt::priv()->registerCPPClass("QDomText", "QDomCharacterData", "QtXml", PythonQtCreateObject<PythonQtWrapper_QDomText>, NULL, module, PythonQt::Type_RichCompare|PythonQt::Type_NonZero);
