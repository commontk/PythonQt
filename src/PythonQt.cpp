...
void PythonQt::initPythonQtModule(bool redirectStdOut, const QByteArray& pythonQtModuleName)
{
  ...
  PyModule_AddObject_DECREF(sys, "pythonqt_original_stdout", PyObject_GetAttrString(sys, "stdout"));
  PyModule_AddObject_DECREF(sys, "pythonqt_original_stderr", PyObject_GetAttrString(sys, "stderr"));
  ...
  // replace the built in file objects with our own objects
  PyModule_AddObject_DECREF(sys, "pythonqt_stdout", out);
  PyModule_AddObject_DECREF(sys, "pythonqt_stderr", err);
