...
QStyleOptionProgressBarV2* PythonQtWrapper_QStyleOptionProgressBarV2::new_QStyleOptionProgressBarV2(int  version)
{ 
return new PythonQtShell_QStyleOptionProgressBarV2(version); }
...
QStyleOptionTabBarBaseV2* PythonQtWrapper_QStyleOptionTabBarBaseV2::new_QStyleOptionTabBarBaseV2(int  version)
{ 
return new PythonQtShell_QStyleOptionTabBarBaseV2(version); }
...
QStyleOptionTabV2* PythonQtWrapper_QStyleOptionTabV2::new_QStyleOptionTabV2(int  version)
{ 
return new PythonQtShell_QStyleOptionTabV2(version); }
...
QStyleOptionTabV3* PythonQtWrapper_QStyleOptionTabV3::new_QStyleOptionTabV3(int  version)
{ 
return new PythonQtShell_QStyleOptionTabV3(version); }
...
QStyleOptionTabWidgetFrameV2* PythonQtWrapper_QStyleOptionTabWidgetFrameV2::new_QStyleOptionTabWidgetFrameV2(int  version)
{ 
return new PythonQtShell_QStyleOptionTabWidgetFrameV2(version); }
...
QStyleOptionToolBoxV2* PythonQtWrapper_QStyleOptionToolBoxV2::new_QStyleOptionToolBoxV2(int  version)
{ 
return new PythonQtShell_QStyleOptionToolBoxV2(version); }
...
QStyleOptionViewItemV2* PythonQtWrapper_QStyleOptionViewItemV2::new_QStyleOptionViewItemV2(int  version)
{ 
return new PythonQtShell_QStyleOptionViewItemV2(version); }
...
QStyleOptionViewItemV3* PythonQtWrapper_QStyleOptionViewItemV3::new_QStyleOptionViewItemV3(int  version)
{ 
return new PythonQtShell_QStyleOptionViewItemV3(version); }
...
QStyleOptionViewItemV4* PythonQtWrapper_QStyleOptionViewItemV4::new_QStyleOptionViewItemV4(int  version)
{ 
return new PythonQtShell_QStyleOptionViewItemV4(version); }
...
{
  return ( ((PythonQtPublicPromoter_QStylePlugin*)theWrappedObject)->promoted_keys());
}
